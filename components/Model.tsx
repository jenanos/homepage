...
import type { MyIslandGLTF } from './models/MyIsland';

type GLTFResult = MyIslandGLTF;

type ModelProps = {
    musicReady: boolean;
    setMusicReady: Dispatch<SetStateAction<boolean>>;
};

export function Model({ musicReady, setMusicReady }: ModelProps) {

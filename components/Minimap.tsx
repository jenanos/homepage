...
export function Minimap({ scale, setCameraPosition }) {
    ...
    return (
        <group scale={4} setCameraPosition={null} dispose={null}>
            <mesh
                ...
                scale={0.03}
                onClick={() => setCameraPosition("about")}
            />
            <mesh
                castShadow
                receiveShadow
                ...
                scale={0.05}
                onClick={() => setCameraPosition("juss")}
            />
            <mesh
                castShadow
                receiveShadow
                ...
                scale={0.04}
                onClick={() => setCameraPosition("music")}
            />
            <mesh
                castShadow
                receiveShadow
                ...
                scale={0.04}
                onClick={() => setCameraPosition("tech")}
            />
            <mesh
                castShadow
                receiveShadow
